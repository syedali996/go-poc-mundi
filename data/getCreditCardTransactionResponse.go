...
var _ json.Unmarshaler = &GetCreditCardTransactionResponse{} 
...
type GetCreditCardTransactionResponseArray struct {
    GetCreditCardTransactionResponseSlice []GetCreditCardTransactionResponseInterface 
}

// decorator for current model to implement custom Unmarshaler
var _ json.Unmarshaler = &GetCreditCardTransactionResponseArray{} 

func (ga *GetCreditCardTransactionResponseArray) UnmarshalJSON(input []byte) error {
    tempStruct := struct {
    	GetCreditCardTransactionResponseSlice []json.RawMessage
    }{}
    ...
    if err != nil {
    	...
    	temp = tempStruct.GetCreditCardTransactionResponseSlice
    }
    
    ga.GetCreditCardTransactionResponseSlice = nil
    if temp != nil {
    	ga.GetCreditCardTransactionResponseSlice = []GetCreditCardTransactionResponseInterface{}
    	for _, getCreditCardTransactionResponse := range temp {
    		if getCreditCardTransactionResponse == nil {
    			ga.GetCreditCardTransactionResponseSlice = append(ga.GetCreditCardTransactionResponseSlice, nil)
    		}
    		...
    		ga.GetCreditCardTransactionResponseSlice = append(ga.GetCreditCardTransactionResponseSlice, &obj)
    	}
    }
    return nil
}
